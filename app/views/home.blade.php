...
<body>
  <div class="center" id="konten-utama">
    <div id="konten-foto">
    ...
    <div>
      ...
      <div class="hilang" id="menu">
        <div id="tombol-menu">
          ...
          <div class="hilang" id="hilang-potong">
            <button type="button" class="btn btn-small tangan" id="simpan-potong">Simpan</button>
            <button type="button" class="btn btn-small tangan" id="batal-potong">Batal</button>
      ...
      <div id="error-filter">
        <div class="alert alert-error fade in hilang" id="error-filter">
          <span id="teks-error-filter"></span>
        </div>
      </div>
    </div>
